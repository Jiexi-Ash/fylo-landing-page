    ...
    <div className="px-8 py-24 container mx-auto max-w-8xl">
      <div className="flex flex-col justify-center items-center md:flex-row-reverse md:justify-between">
        ...
        <div className="flex flex-col pt-10 md:mr-16">
          <div className="max-w-[320px]  text-center  md:text-left lg:max-w-lg lg:text-left ">
            <h1 className="text-2xl font-bold font-openSans  leading-[36px] text-veryDarkBlue md:text-lg lg:text-3xl lg:leading-[60px]">
              All your files in one secure location, accessible anywhere.
            </h1>

            <p className="pt-5 text-veryDarkBlue text-sm lg:text-[17px]">
